        ...
        <div className='container mx-auto px-4'>
          <div className='text-center mb-16'>
            ...
            <p className='text-xl text-gray-600 max-w-3xl mx-auto'>
              Make the most of your Dakhla experience with these photography
              tips
            </p>
          </div>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto'>
            {[
              ...
              >
                ...
                <p className='text-gray-700 leading-relaxed mb-4'>{tip.tip}</p>
        ...
        <div className='container mx-auto px-4 text-center'>
          <div className='max-w-3xl mx-auto'>
            ...
            <p className='text-xl text-gray-600 mb-8'>
              Book your Dakhla kitesurfing adventure and capture your own
              amazing photos in this incredible destination.
            </p>
