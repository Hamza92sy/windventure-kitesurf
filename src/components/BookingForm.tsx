...
import { packagesOptimized as PACKAGES_DATA, type Package, calculatePackageTotal } from '@/data/packages-optimized';
...
export default function BookingForm() {
  ...
  const selectedPackage = PACKAGES_DATA.find((p: Package) => p.id === packageId);
      ...
      <div className="bg-white rounded-2xl shadow-xl p-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          >
            ...
            {isLoading ? 'Processing...' : `Book Now - €${selectedPackage.price}`}
          </button>
